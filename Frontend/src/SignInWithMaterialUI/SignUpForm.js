...
export default function SignUpForm({ onButtonClick, isSuccess }) {
  ...
  return (
    ...
    >
      <div>
        ...
        <div style={{ display: isValid ? "block" : "none", color: "green" }}>
          <img
        ...
        <div style={{ display: isNotValid ? "block" : "none", color: "red" }}>
          <img
            style={{ width: "20px", height: "20px" }}
        ...
        <div>
          <Button
            ...
            disabled={isValid && isEmailValid && !isSuccess ? false : true}
          >
            Sign Up
          </Button>
        </div>
